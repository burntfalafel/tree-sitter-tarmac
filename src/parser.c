...
enum {
  ...
  aux_sym_meta_repeat1 = 62,
  aux_sym_meta_repeat2 = 63,
  aux_sym_meta_repeat3 = 64,
  aux_sym_instruction_repeat1 = 65,
  aux_sym_instruction_repeat2 = 66,
  aux_sym_tarmac_trace_repeat1 = 67,
...
static bool ts_lex(TSLexer *lexer, TSStateId state) {
  ...
  switch (state) {
    ...
    case 103:
      ...
      if (('G' <= lookahead && lookahead <= 'Z')) ADVANCE(153);
      if (('g' <= lookahead && lookahead <= 'z')) ADVANCE(152);
      END_STATE();
    case 104:
      ACCEPT_TOKEN(aux_sym_int_token2);
      if (lookahead == '.') ADVANCE(163);
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [25] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 1, .production_id = 1),
  ...
  [51] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 4, .production_id = 1),
  [53] = {.entry = {.count = 1, .reusable = true}}, SHIFT(46),
  [55] = {.entry = {.count = 1, .reusable = false}}, SHIFT(31),
  [57] = {.entry = {.count = 1, .reusable = false}}, SHIFT(42),
  [59] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 3, .production_id = 1),
  [61] = {.entry = {.count = 2, .reusable = true}}, REDUCE(sym__expr, 1), REDUCE(sym__tc_expr, 1),
  [64] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__expr, 1),
  [66] = {.entry = {.count = 1, .reusable = true}}, SHIFT(93),
  [68] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__tc_expr, 1),
  [70] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tc_expr, 1),
  [72] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_int, 1),
  [74] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_int, 1),
  [76] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_int, 2),
  [78] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_int, 2),
  [80] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reg, 1),
  [82] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reg, 1),
  [84] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ident, 1),
  [86] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_ident, 1),
  [88] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_string, 1),
  [90] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_string, 1),
  [92] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tc_infix, 3, .production_id = 5),
  [94] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_tc_infix, 3, .production_id = 5),
  ...
  [106] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_instruction_repeat2, 1),
  [108] = {.entry = {.count = 1, .reusable = false}}, SHIFT(35),
  [110] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [112] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_instruction_repeat2, 1),
  [114] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_instruction, 2, .production_id = 1),
  [116] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_instruction_repeat2, 2),
  [118] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat2, 2), SHIFT_REPEAT(147),
  [121] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat2, 2), SHIFT_REPEAT(8),
  [124] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat2, 2), SHIFT_REPEAT(13),
  [127] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat2, 2), SHIFT_REPEAT(11),
  [130] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_instruction_repeat2, 2), SHIFT_REPEAT(12),
  [133] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 2),
  [135] = {.entry = {.count = 1, .reusable = true}}, SHIFT(59),
  [137] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 3),
  [139] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta, 1, .production_id = 1),
  [141] = {.entry = {.count = 1, .reusable = true}}, SHIFT(69),
  [143] = {.entry = {.count = 1, .reusable = false}}, SHIFT(79),
  [145] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tarmac_trace_repeat1, 2),
  [147] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tarmac_trace_repeat1, 2), SHIFT_REPEAT(62),
  [150] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tarmac_trace_repeat1, 2), SHIFT_REPEAT(138),
  [153] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_tarmac_trace_repeat1, 2), SHIFT_REPEAT(57),
  [156] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_tarmac_trace_repeat1, 2), SHIFT_REPEAT(58),
  [159] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_tarmac_trace_repeat1, 2), SHIFT_REPEAT(62),
  ...
  [180] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_const, 3, .production_id = 4),
  ...
  [190] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 2), SHIFT_REPEAT(59),
  [193] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 2),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat1, 1),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_program_repeat1, 1),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_tarmac_trace_repeat1, 1),
  [201] = {.entry = {.count = 1, .reusable = false}}, REDUCE(aux_sym_tarmac_trace_repeat1, 1),
  [203] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__tarmac_prefix_token, 1),
  [205] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__tarmac_prefix_token, 1),
  ...
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 2, .production_id = 3),
  [215] = {.entry = {.count = 1, .reusable = true}}, SHIFT(63),
  [217] = {.entry = {.count = 1, .reusable = true}}, SHIFT(27),
  [219] = {.entry = {.count = 1, .reusable = true}}, SHIFT(97),
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 2),
  [223] = {.entry = {.count = 1, .reusable = true}}, SHIFT(64),
  [225] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta, 2, .production_id = 1),
  [227] = {.entry = {.count = 1, .reusable = true}}, SHIFT(125),
  [229] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_meta_repeat2, 2),
  [231] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_meta_repeat2, 2), SHIFT_REPEAT(137),
  [234] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_meta, 3, .production_id = 1),
  [236] = {.entry = {.count = 1, .reusable = true}}, SHIFT(110),
  [238] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_program, 1),
  [240] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_program_repeat2, 2),
  [242] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_program_repeat2, 2), SHIFT_REPEAT(59),
  ...
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ptr, 5),
  [255] = {.entry = {.count = 1, .reusable = true}}, SHIFT(103),
  [257] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ptr, 3),
  [259] = {.entry = {.count = 1, .reusable = true}}, SHIFT(113),
  [261] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2), SHIFT_REPEAT(81),
  [264] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_list_repeat1, 2),
  [266] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_meta_repeat3, 2),
  [268] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_meta_repeat3, 2), SHIFT_REPEAT(110),
  [271] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_meta_repeat1, 2),
  [273] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_meta_repeat1, 2), SHIFT_REPEAT(125),
  [276] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2),
  [278] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_instruction_repeat1, 2), SHIFT_REPEAT(6),
  ...
  [293] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 4),
  [295] = {.entry = {.count = 1, .reusable = true}}, SHIFT(54),
  [297] = {.entry = {.count = 1, .reusable = true}}, SHIFT(107),
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 3),
  [301] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ptr, 7),
  [303] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ptr, 6),
  [305] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 2),
  [307] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_list, 5),
  [309] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_ptr, 4),
  [311] = {.entry = {.count = 1, .reusable = true}}, SHIFT(3),
  [313] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__item, 1),
  [315] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3),
  [317] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 3, .production_id = 3),
  [319] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 5),
  [321] = {.entry = {.count = 1, .reusable = true}}, SHIFT(30),
  [323] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_tarmac_trace, 5, .production_id = 6),
  [325] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 2, .production_id = 2),
  [327] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_label, 5, .production_id = 3),
  ...
  [371] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line_comment, 1),
  [373] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_line_comment, 2),
};
...
extern const TSLanguage *tree_sitter_tarmac(void) {
